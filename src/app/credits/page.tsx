...
export default function CreditsPage() {
    return <div className="text-4xl w-full h-full items-center justify-center gap-2 flex flex-col">
        ...
        <div className="flex gap-2 items-center justify-center">
            ...
            <span>and</span>
            <Mention icon={"/svgs/tailwind.svg"} background padding name="TailwindCSS" href={"https://tailwindcss.com/docs/installation/framework-guides/nextjs/"} />
        </div>
    </div>
}
...
function Mention({ icon, name, href, background, padding }: { icon: string, name: string, href: string, background?: boolean, padding?: boolean }) {
    return <Link href={href} target='_blank' >
        ...
        select-none cursor-pointer hover:scale-102 hover:-rotate-1">
