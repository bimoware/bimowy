...
export default function DashboardPage() {
  const subjects = [
    {
      title: 'Basic Algebra',
      content: 'Operations, PEMDAS, Equations...',
    },
    {
      title: 'Geometry',
      content: 'Points, Lines, Angles, Triangles, Circles, Pythagoras Theorem',
    },
    {
      title: 'Trigonometry',
      content: 'Sine, Cosine, Tangent, Unit Circle, Law of Sines and Cosines',
    },
    {
      title: 'Calculus',
      content: 'Limits, Derivatives, Integrals, Chain Rule, Product Rule',
    },
    {
      title: 'Linear Algebra',
      content: 'Matrices, Determinants, Vectors, Eigenvalues, Eigenvectors',
    },
    {
      title: 'Statistics',
      content: 'Mean, Median, Mode, Standard Deviation, Probability',
    },
    {
      title: 'Set Theory',
      content: 'Union, Intersection, Subsets, Venn Diagrams',
    },
    {
      title: 'Number Theory',
      content: 'Prime Numbers, Divisibility, Greatest Common Divisor, Least Common Multiple',
    },
    {
      title: 'Combinatorics',
      content: 'Permutations, Combinations, Binomial Theorem',
    },
  ]
